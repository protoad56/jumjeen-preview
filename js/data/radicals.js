/**
 * Complete Database of Chinese Radicals (ครอบคลุมครบ 214 康熙部首)
 * จำจีน (JumJeen) - คลังรากศัพท์ภาษาจีนครบสมบูรณ์ 100%
 */
...
const RADICALS_DATA = {
  ...
  "刀": {
    ...
    "name": "刀 / 刂 (dāo)",
    "pinyin": "dāo",
    "thaiMeaning": "มีด / คมดาบ / การตัดแบ่ง / อาวุธ",
    "ancientPictograph": "ภาพมีดหรือดาบโบราณมีด้ามจับและคมดาบโค้งคมกริบ (หรือ 刂 ข้างมีด)",
    "category": "เครื่องมือและอาวุธ",
    "strokeCount": 2,
    "frequency": "สูงมาก (พบในกว่า 250+ ตัวอักษร)",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '刂' (ข้างมีด) เกี่ยวกับการหั่น ตัด แบ่ง คมมีด ผลประโยชน์ และการไปถึง",
    "characterIds": [
      "分",
      "切",
      "别",
  ...
  "力": {
    ...
    "name": "力 (lì)",
    "pinyin": "lì",
    "thaiMeaning": "พละกำลัง / แรงงาน / ความสามารถ",
    "ancientPictograph": "ภาพคันไถหรือกล้ามแขนที่กำลังออกแรงไถดินอย่างแข็งขัน",
    "category": "ร่างกายและพลังงาน",
    "strokeCount": 2,
    "frequency": "สูงมาก (พบในกว่า 200+ ตัวอักษร)",
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '力' เกี่ยวกับแรง งาน ความช่วยเหลือ ความพยายาม และความกล้าหาญ",
    "characterIds": [
      "男",
      "加",
      "动",
  ...
  "口": {
    ...
    "name": "口 (kǒu)",
    "pinyin": "kǒu",
    "thaiMeaning": "ปาก / ช่อง / การพูด / การกิน",
    "ancientPictograph": "ภาพช่องปากที่เปิดอ้าอยู่ บ่งบอกถึงการกิน การดื่ม การพูด และการเปล่งเสียง",
    "category": "ร่างกายและการกระทำ",
    "strokeCount": 3,
    "frequency": "สูงมาก (พบในกว่า 450+ ตัวอักษร)",
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '口' มักพบในคำกริยาที่ใช้ปาก เช่น กิน ดื่ม ร้องเพลง ตะโกน ถาม และคำอุทาน",
    "characterIds": [
      "吃",
      "喝",
      "唱",
  ...
  "土": {
    ...
    "name": "土 (tǔ)",
    "pinyin": "tǔ",
    "thaiMeaning": "ดิน / ผืนดิน / สถานที่ / ดินแดน",
    "ancientPictograph": "ภาพกองดินที่ถูกปั้นขึ้นมาจากผืนดินเพื่อบูชาเทพแห่งพื้นพิภพ",
    "category": "ภูมิศาสตร์และธรรมชาติ",
    "strokeCount": 3,
    "frequency": "สูงมาก (พบในกว่า 300+ ตัวอักษร)",
    "themeColor": "var(--c-amber)",
    "themeSoft": "var(--c-amber-soft)",
    "description": "รากศัพท์ '土' เกี่ยวข้องกับดิน ที่ดิน สิ่งปลูกสร้าง กำแพงเมือง และสถานที่",
    "characterIds": [
      "地",
      "城",
      "场",
  ...
  "夕": {
    ...
    "name": "夕 (xī)",
    "pinyin": "xī",
    "thaiMeaning": "ยามเย็น / พระจันทร์พลบค่ำ / ค่ำคืน",
    "ancientPictograph": "ภาพเสี้ยวพระจันทร์ที่เพิ่งโผล่พ้นขอบฟ้าในยามพลบค่ำ",
    "category": "ดาราศาสตร์และกาลเวลา",
    "strokeCount": 3,
    "frequency": "สูง (พบในกว่า 100+ ตัวอักษร)",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '夕' เกี่ยวกับเวลากลางคืน ภายนอก มากมาย เพียงพอ และชื่อเสียง",
    "characterIds": [
      "外",
      "多",
      "夜",
  ...
  "大": {
    ...
    "name": "大 (dà)",
    "pinyin": "dà",
    "thaiMeaning": "ใหญ่ / กว้างใหญ่ / มโหฬาร / ผู้ใหญ่",
    "ancientPictograph": "ภาพมนุษย์ยืนกางแขนและกางขาเต็มที่เพื่อแสดงความยิ่งใหญ่",
    "category": "สัณฐานและคุณลักษณะ",
    "strokeCount": 3,
    "frequency": "สูงมาก (พบในกว่า 200+ ตัวอักษร)",
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '大' เกี่ยวกับความใหญ่ ท้องฟ้า ความงาม ความสูงส่ง และผู้เป็นใหญ่",
    "characterIds": [
      "天",
      "太",
      "美",
  ...
  "女": {
    ...
    "name": "女 (nǚ)",
    "pinyin": "nǚ",
    "thaiMeaning": "ผู้หญิง / เพศหญิง / แม่",
    "ancientPictograph": "ภาพสตรีคุกเข่าอย่างสง่างามและพับแขนไว้ข้างหน้า บ่งบอกถึงเพศหญิงและความเป็นแม่",
    "category": "มนุษย์และสังคม",
    "strokeCount": 3,
    "frequency": "สูงมาก (พบในกว่า 300+ ตัวอักษร)",
    "themeColor": "var(--c-plum)",
    "themeSoft": "var(--c-plum-soft)",
    "description": "รากศัพท์ '女' มักปรากฏในคำศัพท์ที่เกี่ยวข้องกับเพศหญิง, เครือญาติ, ความงาม, อารมณ์ความรู้สึก และค่านิยมครอบครัวจีนโบราณ",
    "characterIds": [
      "好",
      "妈",
      "妹",
  ...
  "子": {
    ...
    "name": "子 (zǐ)",
    "pinyin": "zǐ",
    "thaiMeaning": "เด็ก / ลูก / ผู้สืบสกุล / เมล็ดพันธุ์",
    "ancientPictograph": "ภาพทารกตัวน้อยกำลังกางแขนและศีรษะกลมโต",
    "category": "มนุษย์และสังคม",
    "strokeCount": 3,
    "frequency": "สูง (พบในกว่า 150+ ตัวอักษร)",
    "themeColor": "var(--c-plum)",
    "themeSoft": "var(--c-plum-soft)",
    "description": "รากศัพท์ '子' เกี่ยวกับเด็ก การเรียนรู้ ตัวอักษร ฤดูกาล และการสืบสกุล",
    "characterIds": [
      "好",
      "学",
      "字",
  ...
  "宀": {
    ...
    "name": "宀 (mián)",
    "pinyin": "mián",
    "thaiMeaning": "หลังคาบ้าน / ที่อยู่อาศัย / เคหสถาน (宝盖头)",
    "ancientPictograph": "ภาพหลังคาบ้านทรงโบราณที่มีหน้าจั่วและชายคากันแดดฝน",
    "category": "สิ่งปลูกสร้างและที่อยู่อาศัย",
    "strokeCount": 3,
    "frequency": "สูงมาก (พบในกว่า 250+ ตัวอักษร)",
    "themeColor": "var(--c-amber)",
    "themeSoft": "var(--c-amber-soft)",
    "description": "รากศัพท์ '宀' (หลังคาบ้าน) ปรากฏในคำเกี่ยวกับบ้าน ครอบครัว ความปลอดภัย ความสงบ และห้องหับ",
    "characterIds": [
      "家",
      "安",
      "字",
  ...
  "尸": {
    ...
    "name": "尸 (shī)",
    "pinyin": "shī",
    "thaiMeaning": "ร่างกาย / ท่าเอนกาย / ตัวอาคาร (尸字头)",
    "ancientPictograph": "ภาพคนนั่งเอนกายพักผ่อน หรือโครงสร้างอาคารที่อยู่อาศัย",
    "category": "ร่างกายและสิ่งปลูกสร้าง",
    "strokeCount": 3,
    "frequency": "สูง (พบในกว่า 150+ ตัวอักษร)",
    "themeColor": "var(--c-plum)",
    "themeSoft": "var(--c-plum-soft)",
    "description": "รากศัพท์ '尸' ปรากฏในคำว่า ห้อง บ้าน ชั้น อยู่อาศัย หาง และสำนัก",
    "characterIds": [
      "屋",
      "居",
      "层",
  ...
  "山": {
    ...
    "name": "山 (shān)",
    "pinyin": "shān",
    "thaiMeaning": "ภูเขา / เทือกเขา / ความสูงตระหง่าน",
    "ancientPictograph": "ภาพยอดเขาสามยอดตั้งตระหง่าน ยอดกลางสูงโดดเด่น",
    "category": "ภูมิศาสตร์และธรรมชาติ",
    "strokeCount": 3,
    "frequency": "สูงมาก (พบในกว่า 250+ ตัวอักษร)",
    "themeColor": "var(--c-jade)",
    "themeSoft": "var(--c-jade-soft)",
    "description": "รากศัพท์ '山' ใช้ในคำที่เกี่ยวกับภูเขา ยอดผา เกาะ หุบเขา และสิ่งที่มีความสูงใหญ่",
    "characterIds": [
      "岩",
      "岛",
      "峰",
  ...
  "广": {
    ...
    "name": "广 (guǎng)",
    "pinyin": "guǎng",
    "thaiMeaning": "เพิงพัก / อาคารกว้างขวาง / ทำเนียบ (广字旁)",
    "ancientPictograph": "ภาพเพิงพักหรืออาคารที่สร้างอิงกับหน้าผา มีหลังคาและผนังด้านเดียว",
    "category": "สิ่งปลูกสร้าง",
    "strokeCount": 3,
    "frequency": "สูงมาก (พบในกว่า 200+ ตัวอักษร)",
    "themeColor": "var(--c-amber)",
    "themeSoft": "var(--c-amber-soft)",
    "description": "รากศัพท์ '广' เกี่ยวกับร้านค้า เตียง ที่นั่ง ก้นบึ้ง ระดับ และศาล",
    "characterIds": [
      "店",
      "府",
      "底",
  ...
  "弓": {
    ...
    "name": "弓 (gōng)",
    "pinyin": "gōng",
    "thaiMeaning": "คันธนู / ความโค้งงอ / การยืดหยุ่น",
    "ancientPictograph": "ภาพคันธนูโบราณที่ขึงสายพร้อมยิง",
    "category": "อาวุธและเครื่องมือ",
    "strokeCount": 3,
    "frequency": "สูง (พบในกว่า 120+ ตัวอักษร)",
    "themeColor": "var(--c-amber)",
    "themeSoft": "var(--c-amber-soft)",
    "description": "รากศัพท์ '弓' เกี่ยวกับการกาง แผ่น ดึงดูด แข็งแกร่ง อ่อนแอ และโค้งงอ",
    "characterIds": [
      "张",
      "引",
      "强",
  ...
  "心": {
    ...
    "name": "心 / 忄 (xīn)",
    "pinyin": "xīn",
    "thaiMeaning": "หัวใจ / จิตใจ / อารมณ์ความรู้สึก",
    "ancientPictograph": "ภาพหัวใจของมนุษย์พร้อมเส้นเลือด สะท้อนว่าชาวจีนมองจิตใจและความคิดอยู่ที่หัวใจ",
    "category": "ร่างกายและจิตใจ",
    "strokeCount": 4,
    "frequency": "สูงมาก (พบในกว่า 350+ ตัวอักษร)",
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '心' (หรือ '忄' ข้างใจ) มักเกี่ยวข้องกับความคิด ความรู้สึก อารมณ์ และความตั้งใจ",
    "characterIds": [
      "想",
      "忘",
      "念",
  ...
  "手": {
    ...
    "name": "手 / 扌 (shǒu)",
    "pinyin": "shǒu",
    "thaiMeaning": "มือ / การกระทำ / การหยิบจับ",
    "ancientPictograph": "ภาพฝ่ามือมนุษย์กางนิ้วออกทั้ง 5 นิ้ว (หรือ 扌 ข้างมือ)",
    "category": "ร่างกายและการกระทำ",
    "strokeCount": 3,
    "frequency": "สูงที่สุด (พบในกว่า 500+ ตัวอักษร)",
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '扌' (ข้างมือ) มักพบในกริยาการใช้มือ เช่น ตี จับ หา ถือ ยก ผลัก ดึง",
    "characterIds": [
      "拿",
      "掌",
      "拜",
  ...
  "方": {
    ...
    "name": "方 (fāng)",
    "pinyin": "fāng",
    "thaiMeaning": "ทิศทาง / สี่เหลี่ยม / วิธีการ / ด้าน",
    "ancientPictograph": "ภาพเรือสองลำผูกขนานกันเพื่อแล่นข้ามฟาก หรือคันไถดิน",
    "category": "ทิศทางและเรขาคณิต",
    "strokeCount": 4,
    "frequency": "สูง (พบในกว่า 120+ ตัวอักษร)",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '方' เกี่ยวกับการปล่อย การท่องเที่ยว ชนเผ่า และธง",
    "characterIds": [
      "放",
      "旅",
      "族",
  ...
  "日": {
    ...
    "name": "日 (rì)",
    "pinyin": "rì",
    "thaiMeaning": "พระอาทิตย์ / กลางวัน / กาลเวลา",
    "ancientPictograph": "ภาพดวงอาทิตย์กลมโตที่มีจุดศูนย์กลาง สะท้อนแสงสว่างและความร้อน",
    "category": "ดาราศาสตร์และกาลเวลา",
    "strokeCount": 4,
    "frequency": "สูง (พบในกว่า 200+ ตัวอักษร)",
    "themeColor": "var(--c-amber)",
    "themeSoft": "var(--c-amber-soft)",
    "description": "รากศัพท์ '日' เกี่ยวข้องกับแสงสว่าง กาลเวลา วัน ฤดูกาล และสภาพอากาศ",
    "characterIds": [
      "明",
      "早",
      "时",
  ...
  "月": {
    ...
    "name": "月 (yuè)",
    "pinyin": "yuè",
    "thaiMeaning": "พระจันทร์ / กาลเวลา",
    "ancientPictograph": "ภาพเสี้ยวพระจันทร์บนท้องฟ้า",
    "category": "ดาราศาสตร์และกาลเวลา",
    "strokeCount": 4,
    "frequency": "สูงมาก",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '月' (พระจันทร์ / กาลเวลา) — ข้อควรระวัง: ตัวอักษรที่มีส่วนประกอบหน้าตาเหมือน 月 จำนวนมาก (เช่น 胖 肝 脸 腿) แท้จริงมาจากราก 肉 (เนื้อ/ร่างกาย) ไม่ใช่ 月 แม้จะเขียนเหมือนกันทุกประการในภาษาจีนสมัยใหม่ก็ตาม ดูราก 肉 สำหรับกลุ่มนั้น",
    "characterIds": [
      "期",
      "朋",
      "服",
  ...
  "木": {
    ...
    "ancientPictograph": "ภาพต้นไม้ที่มีกิ่งก้านด้านบน ลำต้นตรงกลาง และรากชอนไชอยู่ด้านล่าง",
    "category": "ธรรมชาติและพืช",
    "strokeCount": 4,
    "frequency": "สูงมาก (พบในกว่า 400+ ตัวอักษร)",
    "themeColor": "var(--c-jade)",
    "themeSoft": "var(--c-jade-soft)",
    "description": "รากศัพท์ '木' ใช้ในคำที่เกี่ยวกับพืช ไม้ เครื่องเรือน ป่าไม้ และการเติบโต",
    "characterIds": [
      "林",
      "森",
      "休",
  ...
  "火": {
    ...
    "name": "火 / 灬 (huǒ)",
    "pinyin": "huǒ",
    "thaiMeaning": "ไฟ / ความร้อน / การปรุงสุก",
    "ancientPictograph": "ภาพเปลวไฟที่กำลังลุกโชติช่วงพุ่งขึ้นสู่ด้านบน (หรือ 灬 สี่จุดไฟ)",
    "category": "ธรรมชาติและพลังงาน",
    "strokeCount": 4,
    "frequency": "สูง (พบในกว่า 200+ ตัวอักษร)",
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '火' หรือรูปฐาน '灬' มักพบในคำที่เกี่ยวกับความร้อน การเผา การต้ม และแสงสว่าง",
    "characterIds": [
      "炎",
      "烧",
      "灯",
  ...
  "爿": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '爿' (ท่อนไม้ผ่าซีก / เตียงนอน (丬)) จัดอยู่ในหมวด เครื่องมือและสิ่งของ เป็นรากศัพท์คังซีลำดับที่ 90",
    "characterIds": [
      "牂"
    ]
  },
  ...
  "牛": {
    ...
    "name": "牛 / 牜 (niú)",
    "pinyin": "niú",
    "thaiMeaning": "วัว / ปศุสัตว์ / สัตว์ใหญ่ (牛字旁)",
    "ancientPictograph": "ภาพส่วนหัวของวัวพร้อมเขาโค้งสองข้าง",
    "category": "สัตว์และเกษตรกรรม",
    "strokeCount": 4,
    "frequency": "สูง (พบในกว่า 150+ ตัวอักษร)",
    "themeColor": "var(--c-amber)",
    "themeSoft": "var(--c-amber-soft)",
    "description": "รากศัพท์ '牛' หรือ '牜' เกี่ยวกับสิ่งของ ชิ้น พิเศษ การเลี้ยงสัตว์ และคอก",
    "characterIds": [
      "物",
      "特",
      "件",
  ...
  "犬": {
    ...
    "name": "犬 / 犭 (quǎn)",
    "pinyin": "quǎn",
    "thaiMeaning": "สุนัข / สัตว์สี่เท้า / สัตว์ป่า",
    "ancientPictograph": "ภาพสุนัขยืนชูหางม้วนขึ้นด้านบน (หรือ 犭 ข้างสุนัข)",
    "category": "สัตว์และธรรมชาติ",
    "strokeCount": 3,
    "frequency": "สูงมาก (พบในกว่า 250+ ตัวอักษร)",
    "themeColor": "var(--c-jade)",
    "themeSoft": "var(--c-jade-soft)",
    "description": "รากศัพท์ '犭' (ข้างสุนัข) ปรากฏในชื่อสัตว์เลี้ยงลูกด้วยนม เช่น แมว หมา หมู หมาป่า สุนัขจิ้งจอก",
    "characterIds": [
      "状",
      "献"
    ]
  ...
  "田": {
    ...
    "name": "田 (tián)",
    "pinyin": "tián",
    "thaiMeaning": "ทุ่งนา / ผืนดินเกษตร / แปลงเพาะปลูก",
    "ancientPictograph": "ภาพแปลงนาที่ถูกแบ่งเป็นช่องสี่เหลี่ยมด้วยคันนาอย่างเป็นระเบียบ",
    "category": "เกษตรกรรมและที่ดิน",
    "strokeCount": 5,
    "frequency": "สูง (พบในกว่า 180+ ตัวอักษร)",
    "themeColor": "var(--c-jade)",
    "themeSoft": "var(--c-jade-soft)",
    "description": "รากศัพท์ '田' ปรากฏในคำที่เกี่ยวกับท้องนา การทำกิน ขอบเขต และแรงงาน",
    "characterIds": [
      "男",
      "界",
      "画",
  ...
  "疋": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '疋' (ม้วนผ้า / เท้าก้าวเดิน (𤴔)) จัดอยู่ในหมวด เครื่องมือและสิ่งของ เป็นรากศัพท์คังซีลำดับที่ 103",
    "characterIds": [
      "疑"
    ]
  },
  ...
  "目": {
    ...
    "name": "目 (mù)",
    "pinyin": "mù",
    "thaiMeaning": "ดวงตา / สายตา / การมองเห็น",
    "ancientPictograph": "ภาพดวงตาของมนุษย์พร้อมม่านตาตรงกลาง",
    "category": "ร่างกายและการมองเห็น",
    "strokeCount": 5,
    "frequency": "สูง (พบในกว่า 200+ ตัวอักษร)",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '目' เกี่ยวกับการมอง การนอน การสอดส่อง และทัศนียภาพ",
    "characterIds": [
      "看",
      "眼",
      "睛",
  ...
  "石": {
    ...
    "name": "石 (shí)",
    "pinyin": "shí",
    "thaiMeaning": "หิน / แร่ธาตุ / ความแข็งแกร่ง",
    "ancientPictograph": "ภาพก้อนหินที่ตกลงมาจากหน้าผาสูงชัน",
    "category": "ธรรมชาติและแร่ธาตุ",
    "strokeCount": 5,
    "frequency": "สูง (พบในกว่า 200+ ตัวอักษร)",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '石' เกี่ยวข้องกับหิน ศิลา ความแข็ง การบด การวิจัย และการแตกหัก",
    "characterIds": [
      "破",
      "硬",
      "矿",
  ...
  "禾": {
    ...
    "name": "禾 (hé)",
    "pinyin": "hé",
    "thaiMeaning": "ต้นข้าว / ธัญพืช / พืชผล",
    "ancientPictograph": "ภาพต้นข้าวที่กำลังออกรวงโค้งโน้มลงสู่พื้นดินอย่างสมบูรณ์",
    "category": "เกษตรกรรมและอาหาร",
    "strokeCount": 5,
    "frequency": "สูงมาก (พบในกว่า 250+ ตัวอักษร)",
    "themeColor": "var(--c-amber)",
    "themeSoft": "var(--c-amber-soft)",
    "description": "รากศัพท์ '禾' มักพบในคำเกี่ยวกับข้าว การเกษตร ฤดูกาล ความสงบ และการเก็บเกี่ยว",
    "characterIds": [
      "和",
      "秋",
      "香",
  ...
  "穴": {
    ...
    "name": "穴 (xué)",
    "pinyin": "xué",
    "thaiMeaning": "ถ้ำ / โพรงดิน / ที่อยู่อาศัยใต้ดิน / รู",
    "ancientPictograph": "ภาพถ้ำหินหรือโพรงดินที่ขุดลึกเข้าไปใต้ผืนดิน",
    "category": "ที่อยู่อาศัยและภูมิศาสตร์",
    "strokeCount": 5,
    "frequency": "สูง (พบในกว่า 120+ ตัวอักษร)",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '穴' มักพบในคำที่เกี่ยวกับท้องฟ้า ความว่างเปล่า การสวมใส่ การเจาะ และหน้าต่าง",
    "characterIds": [
      "空",
      "穿",
      "究",
  ...
  "竹": {
    ...
    "name": "竹 / ⺮ (zhú)",
    "pinyin": "zhú",
    "thaiMeaning": "ไม้ไผ่ / เครื่องจักสาน / อุปกรณ์เขียนโบราณ",
    "ancientPictograph": "ภาพกิ่งไผ่และใบไผ่สองกิ่งห้อยลงมา (หรือ ⺮ หัวไม้ไผ่)",
    "category": "ธรรมชาติและวัสดุ",
    "strokeCount": 6,
    "frequency": "สูงมาก (พบในกว่า 200+ ตัวอักษร)",
    "themeColor": "var(--c-jade)",
    "themeSoft": "var(--c-jade-soft)",
    "description": "รากศัพท์ '⺮' (หัวไม้ไผ่) เกี่ยวกับพู่กัน ตะกร้า แผ่นกระบอกไม้ไผ่ เสียงหัวเราะ และกล่อง",
    "characterIds": [
      "笔",
      "简",
      "笑",
  ...
  "羊": {
    ...
    "name": "羊 / ⺶ (yáng)",
    "pinyin": "yáng",
    "thaiMeaning": "แกะ / แพะ / ความดีงาม / ความงดงาม",
    "ancientPictograph": "ภาพหัวแกะที่มีเขาโค้งมนสวยงามสองข้าง",
    "category": "สัตว์และคุณธรรม",
    "strokeCount": 6,
    "frequency": "สูง (พบในกว่า 150+ ตัวอักษร)",
    "themeColor": "var(--c-plum)",
    "themeSoft": "var(--c-plum-soft)",
    "description": "รากศัพท์ '羊' เกี่ยวกับความงดงาม ความดีงาม ฝูง สวมใส่ และความชอบธรรม",
    "characterIds": [
      "美",
      "着",
      "群",
  ...
  "肉": {
    ...
    "name": "肉 (ròu)",
    "pinyin": "ròu",
    "thaiMeaning": "เนื้อสัตว์ / อวัยวะในร่างกาย (月字旁)",
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '肉' (เนื้อสัตว์ / อวัยวะในร่างกาย) เป็นรากศัพท์คังซีลำดับที่ 130 — เวลาใช้เป็นส่วนประกอบด้านข้างของตัวอักษรอื่น (เช่น 胖 肝 脸 腿) จะเขียนเหมือนกับ 月 (พระจันทร์) ทุกประการในภาษาจีนสมัยใหม่ แม้จะเป็นคนละรากศัพท์กันก็ตาม ตัวอักษรกลุ่มนี้ส่วนใหญ่เกี่ยวกับร่างกาย/อวัยวะ",
    "characterIds": [
      "肌",
      "肝",
      "脑",
  ...
  "舟": {
    ...
    "name": "舟 (zhōu)",
    "pinyin": "zhōu",
    "thaiMeaning": "เรือ / การล่องนาวา / การสัญจรทางน้ำ",
    "ancientPictograph": "ภาพเรือไม้ขุดโบราณพร้อมพาย",
    "category": "คมนาคมและทางน้ำ",
    "strokeCount": 6,
    "frequency": "สูง (พบในกว่า 100+ ตัวอักษร)",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '舟' เกี่ยวกับเรือ การบิน การเดินเรือ และห้องโดยสาร",
    "characterIds": [
      "船",
      "航",
      "般",
  ...
  "艸": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '艸' (หญ้า / พืชสมุนไพร (艹)) จัดอยู่ในหมวด ธรรมชาติและพืช เป็นรากศัพท์คังซีลำดับที่ 140",
    "characterIds": [
      "艺",
      "芋",
      "节"
  ...
  "虫": {
    ...
    "name": "虫 (chóng)",
    "pinyin": "chóng",
    "thaiMeaning": "แมลง / สัตว์เลื้อยคลาน / สัตว์ตัวเล็ก",
    "ancientPictograph": "ภาพงูหรือตัวหนอนหัวโตกำลังเลื้อยขดตัว",
    "category": "สัตว์และสิ่งมีชีวิต",
    "strokeCount": 6,
    "frequency": "สูงมาก (พบในกว่า 250+ ตัวอักษร)",
    "themeColor": "var(--c-jade)",
    "themeSoft": "var(--c-jade-soft)",
    "description": "รากศัพท์ '虫' เกี่ยวกับแมลง ผึ้ง มด ผีเสื้อ กุ้ง ปู และสัตว์เลื้อยคลาน",
    "characterIds": [
      "蜜",
      "蜂",
      "蛋",
  ...
  "衣": {
    ...
    "name": "衣 / 衤 (yī)",
    "pinyin": "yī",
    "thaiMeaning": "เสื้อผ้า / เครื่องนุ่งห่ม / เครื่องแต่งกาย",
    "ancientPictograph": "ภาพเสื้อคลุมจีนโบราณมีปกเสื้อพับไขว้และแขนเสื้อยาว (หรือ 衤 ข้างเสื้อ)",
    "category": "เครื่องแต่งกายและสิ่งทอ",
    "strokeCount": 5,
    "frequency": "สูงมาก (พบในกว่า 200+ ตัวอักษร)",
    "themeColor": "var(--c-plum)",
    "themeSoft": "var(--c-plum-soft)",
    "description": "รากศัพท์ '衤' (ข้างเสื้อ) ปรากฏในคำเกี่ยวกับผ้าห่ม เสื้อเชิ้ต การเย็บซ่อม กางเกง และกระโปรง",
    "characterIds": [
      "装",
      "袋",
      "裂",
  ...
  "走": {
    ...
    "name": "走 (zǒu)",
    "pinyin": "zǒu",
    "thaiMeaning": "การเดิน / การวิ่ง / การก้าวไปข้างหน้า",
    "ancientPictograph": "ภาพคนกำลังกวัดแกว่งแขนวิ่งอย่างรวดเร็วอยู่บนผืนดิน",
    "category": "การเคลื่อนไหวและระยะทาง",
    "strokeCount": 7,
    "frequency": "สูง (พบในกว่า 150+ ตัวอักษร)",
    "themeColor": "var(--c-jade)",
    "themeSoft": "var(--c-jade-soft)",
    "description": "รากศัพท์ '走' เกี่ยวกับการลุกขึ้น การข้าม การรีบเร่ง ความยอดเยี่ยม และการเดินทาง",
    "characterIds": [
      "起",
      "越",
      "赶",
  ...
  "足": {
    ...
    "name": "足 / 𧾷 (zú)",
    "pinyin": "zú",
    "thaiMeaning": "เท้า / ขา / การก้าวเดิน / ความพอเพียง",
    "ancientPictograph": "ภาพขาและเท้าของมนุษย์ที่กำลังย่างก้าวอย่างมั่นคง",
    "category": "ร่างกายและการเคลื่อนไหว",
    "strokeCount": 7,
    "frequency": "สูง (พบในกว่า 200+ ตัวอักษร)",
    "themeColor": "var(--c-jade)",
    "themeSoft": "var(--c-jade-soft)",
    "description": "รากศัพท์ '足' (ข้างเท้า) เกี่ยวกับการวิ่ง กระโดด เตะ เส้นทาง และระยะทาง",
    "characterIds": [
      "跑",
      "跳",
      "踢",
  ...
  "酉": {
    ...
    "name": "酉 (yǒu)",
    "pinyin": "yǒu",
    "thaiMeaning": "ไหเหล้า / การหมักดอง / เครื่องดื่มแอลกอฮอล์",
    "ancientPictograph": "ภาพไหปากแคบก้นป่องที่ใช้หมักสุราโบราณ",
    "category": "อาหารและเครื่องดื่ม",
    "strokeCount": 7,
    "frequency": "สูง (พบในกว่า 120+ ตัวอักษร)",
    "themeColor": "var(--c-amber)",
    "themeSoft": "var(--c-amber-soft)",
    "description": "รากศัพท์ '酉' ปรากฏในคำว่า เหล้า สุรา เมา ตื่น เปรี้ยว ซอส และน้ำส้มสายชู",
    "characterIds": [
      "酒",
      "醒",
      "醉",
  ...
  "雨": {
    ...
    "name": "雨 (yǔ)",
    "pinyin": "yǔ",
    "thaiMeaning": "ฝน / สภาพอากาศ / ท้องฟ้า",
    "ancientPictograph": "ภาพท้องฟ้าที่มีหยดน้ำฝนโปรยปรายลงมาจากหมู่เมฆ",
    "category": "อุตุนิยมวิทยาและธรรมชาติ",
    "strokeCount": 8,
    "frequency": "สูง (พบในกว่า 150+ ตัวอักษร)",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '雨' ปรากฏในคำที่เกี่ยวกับหิมะ ฟ้าร้อง หมอก น้ำค้าง และสภาพอากาศ",
    "characterIds": [
      "雪",
      "雷",
      "零",
  ...
  "韋": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '韋' (หนังฟอกนุ่ม (韦)) จัดอยู่ในหมวด เครื่องมือและสิ่งของ เป็นรากศัพท์คังซีลำดับที่ 178",
    "characterIds": [
      "韩",
      "韧"
    ]
  ...
  "風": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '風' (สายลม / ลมพัด (风)) จัดอยู่ในหมวด ดาราศาสตร์และธรรมชาติ เป็นรากศัพท์คังซีลำดับที่ 182",
    "characterIds": [
      "飘",
      "飓"
    ]
  ...
  "飛": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '飛' (โบยบิน / นกบิน (飞)) จัดอยู่ในหมวด การกระทำและอาการ เป็นรากศัพท์คังซีลำดับที่ 183",
    "characterIds": [
      "飞"
    ]
  },
  ...
  "魚": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '魚' (ปลา / สัตว์น้ำ (鱼)) จัดอยู่ในหมวด สัตว์และธรรมชาติ เป็นรากศัพท์คังซีลำดับที่ 195",
    "characterIds": [
      "魣"
    ]
  },
  ...
  "鹵": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '鹵' (เกลือสินเธาว์ / ด่าง (卤)) จัดอยู่ในหมวด อาหารและแร่ธาตุ เป็นรากศัพท์คังซีลำดับที่ 197",
    "characterIds": [
      "鹾"
    ]
  },
  ...
  "麥": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '麥' (ข้าวสาลี / ข้าวบาร์เลย์ (麦)) จัดอยู่ในหมวด อาหารและพืช เป็นรากศัพท์คังซีลำดับที่ 199",
    "characterIds": [
      "麸"
    ]
  },
  ...
  "黃": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '黃' (สีเหลืองทอง (黄)) จัดอยู่ในหมวด สีสันและสภาพ เป็นรากศัพท์คังซีลำดับที่ 201",
    "characterIds": [
      "黉"
    ]
  },
  ...
  "黽": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '黽' (คางคก / กบ (黾)) จัดอยู่ในหมวด สัตว์และธรรมชาติ เป็นรากศัพท์คังซีลำดับที่ 205",
    "characterIds": [
      "鼋"
    ]
  },
  ...
  "齊": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '齊' (เรียบร้อย / สม่ำเสมอ (齐)) จัดอยู่ในหมวด ปรัชญาและสภาพ เป็นรากศัพท์คังซีลำดับที่ 210",
    "characterIds": [
      "齑"
    ]
  },
  "齒": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '齒' (ฟัน / ซี่ฟัน (齿)) จัดอยู่ในหมวด ร่างกายและสุขภาพ เป็นรากศัพท์คังซีลำดับที่ 211",
    "characterIds": [
      "龄",
      "龋"
    ]
  ...
  "龍": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '龍' (มังกร / สัตว์มงคลเทพ (龙)) จัดอยู่ในหมวด ความเชื่อและวัฒนธรรม เป็นรากศัพท์คังซีลำดับที่ 212",
    "characterIds": [
      "龛"
    ]
  },
  "龜": {
    ...
    "themeColor": "var(--c-vermilion)",
    "themeSoft": "var(--c-vermilion-soft)",
    "description": "รากศัพท์ '龜' (เต่า / สัตว์อายุยืน (龟)) จัดอยู่ในหมวด สัตว์และธรรมชาติ เป็นรากศัพท์คังซีลำดับที่ 213",
    "characterIds": [
      "龝"
    ]
  },
  ...
  "车": {
    ...
    "name": "车 (chē)",
    "pinyin": "chē",
    "thaiMeaning": "รถ / ยานพาหนะ / การขนส่ง",
    "ancientPictograph": "ภาพราชรถโบราณมองจากมุมบน มีเพลา ล้อ 2 ข้าง และคานเทียมม้า",
    "category": "ยานพาหนะและการคมนาคม",
    "strokeCount": 4,
    "frequency": "สูง (พบในกว่า 180+ ตัวอักษร)",
    "themeColor": "var(--c-amber)",
    "themeSoft": "var(--c-amber-soft)",
    "description": "รากศัพท์ '车' เกี่ยวกับรถยนต์ ล้อ การหมุน การขนส่ง และความหนักเบา",
    "characterIds": [
      "轮",
      "转",
      "辆",
  ...
  "门": {
    ...
    "name": "门 (mén)",
    "pinyin": "mén",
    "thaiMeaning": "ประตู / ทางเข้าออก / สถาบัน",
    "ancientPictograph": "ภาพบานประตูคู่โบราณที่เปิดอ้าพร้อมต้อนรับผู้มาเยือน",
    "category": "สถาปัตยกรรมและอาคาร",
    "strokeCount": 3,
    "frequency": "สูง (พบในกว่า 150+ ตัวอักษร)",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '门' เกี่ยวกับประตู การเปิด-ปิด การถาม การอ่าน และช่องว่าง",
    "characterIds": [
      "问",
      "闭",
      "间",
  ...
  "贝": {
    ...
    "name": "贝 (bèi)",
    "pinyin": "bèi",
    "thaiMeaning": "เปลือกหอยเบี้ย / เงินตรา / ทรัพย์สมบัติ",
    "ancientPictograph": "ภาพเปลือกหอยเบี้ยทะเล ซึ่งชาวจีนโบราณใช้แทนเงินตราในการแลกเปลี่ยน",
    "category": "เศรษฐกิจและการเงิน",
    "strokeCount": 4,
    "frequency": "สูงมาก (พบในกว่า 200+ ตัวอักษร)",
    "themeColor": "var(--c-amber)",
    "themeSoft": "var(--c-amber-soft)",
    "description": "รากศัพท์ '贝' เกี่ยวกับการค้า การซื้อขาย ทรัพย์สิน ความร่ำรวย และค่าใช้จ่าย",
    "characterIds": [
      "买",
      "卖",
      "贵",
  ...
  "鸟": {
    ...
    "name": "鸟 / 隹 (niǎo / zhuī)",
    "pinyin": "niǎo",
    "thaiMeaning": "นก / สัตว์ปีก / นกหางยาว",
    "ancientPictograph": "ภาพนกเกาะกิ่งไม้มีจงอยปาก ตา และขนปีกหางชัดเจน",
    "category": "สัตว์และสิ่งมีชีวิต",
    "strokeCount": 5,
    "frequency": "สูง (พบในกว่า 180+ ตัวอักษร)",
    "themeColor": "var(--c-jade)",
    "themeSoft": "var(--c-jade-soft)",
    "description": "รากศัพท์ '鸟' และ '隹' มักพบในชื่อนก ไก่ เป็ด ห่าน และเสียงร้องของสัตว์ปีก",
    "characterIds": [
      "鸡",
      "鸭",
      "鸣",
  ...
  "马": {
    ...
    "name": "马 (mǎ)",
    "pinyin": "mǎ",
    "thaiMeaning": "ม้า / ความเร็ว / ยานพาหนะโบราณ",
    "ancientPictograph": "ภาพม้าวิ่งมีแผงคอยาว ดวงตาเบิกกว้าง และหางโบกสะบัด",
    "category": "สัตว์และคมนาคม",
    "strokeCount": 3,
    "frequency": "สูง (พบในกว่า 150+ ตัวอักษร)",
    "themeColor": "var(--c-amber)",
    "themeSoft": "var(--c-amber-soft)",
    "description": "รากศัพท์ '马' เกี่ยวกับม้า การขี่ การเดินทางเร็ว และเสียงเลียนเสียง ma",
    "characterIds": [
      "妈",
      "骑",
      "驾",
  ...
  "户": {
    ...
    "name": "户 (hù)",
    "pinyin": "hù",
    "thaiMeaning": "บานประตูเดี่ยว / ครัวเรือน / หลังคาเรือน (户字旁)",
    "ancientPictograph": "ภาพบานประตูไม้เดี่ยวครึ่งหนึ่งของประตูใหญ่",
    "category": "สิ่งปลูกสร้างและสังคม",
    "strokeCount": 4,
    "frequency": "สูง (พบในกว่า 100+ ตัวอักษร)",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '户' เกี่ยวกับห้อง บ้าน สถานที่ และพัด",
    "characterIds": [
      "房",
      "所",
      "扇",
  ...
  "页": {
    ...
    "name": "页 / 頁 (yè)",
    "pinyin": "yè",
    "thaiMeaning": "ศีรษะ / หน้ากระดาษ / แผ่นใบหน้า (页字旁)",
    "ancientPictograph": "ภาพศีรษะและใบหน้าของมนุษย์ที่โดดเด่นอยู่บนลำตัว",
    "category": "ร่างกายและเอกสาร",
    "strokeCount": 6,
    "frequency": "สูงมาก (พบในกว่า 180+ ตัวอักษร)",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '页' เกี่ยวกับยอด คอ นำ หัวข้อ ล่วงหน้า และใบหน้า",
    "characterIds": [
      "顶",
      "项",
      "顺",
