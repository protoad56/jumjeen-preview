...
const RADICALS_DATA = {
  ...
  "月": {
    ...
    "name": "月 / 肉 (yuè / ròu)",
    "pinyin": "yuè",
    "thaiMeaning": "พระจันทร์ / กาลเวลา / ร่างกายและเนื้อหนัง (月字旁)",
    "ancientPictograph": "ภาพเสี้ยวพระจันทร์บนท้องฟ้า หรือก้อนเนื้อเยื่อร่างกายมนุษย์",
    "category": "ดาราศาสตร์และร่างกาย",
    "strokeCount": 4,
    "frequency": "สูงมาก (พบในกว่า 300+ ตัวอักษร)",
    "themeColor": "var(--c-indigo)",
    "themeSoft": "var(--c-indigo-soft)",
    "description": "รากศัพท์ '月' ใช้ทั้งเรื่องดวงจันทร์ กาลเวลา และอวัยวะร่างกายมนุษย์ (ข้างเนื้อ)",
    "characterIds": [
      "期",
      "朋",
      "服",
